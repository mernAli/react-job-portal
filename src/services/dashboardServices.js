    ...
    setTimeout(() => {
      resolve([
        ...
        },
        {
          id: 2,
          type: "shortlist",
          message: "Sarah Johnson shortlisted for UI/UX Designer",
          time: "5 hours ago",
          icon: "⭐",
        },
        {
          id: 3,
          type: "job",
          message: "Your job post 'Backend Developer' is now live",
          time: "1 day ago",
          icon: "💼",
        },
        {
          id: 4,
          type: "hired",
          message: "Mike Chen accepted the offer for React Developer",
          time: "2 days ago",
          icon: "✅",
        },
      ]);
