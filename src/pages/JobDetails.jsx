    ...
    try {
      ...
      if (foundJob) {
        ...
        const transformedJob = {
          ...
          tags: foundJob.tags || [],
          url: foundJob.url,
          postedDate: new Date(foundJob.created_at * 1000).toLocaleDateString("en-US", {
            day: "numeric",
            month: "short",
            year: "numeric",
          }),
          ...
          deadline: new Date(Date.now() + Math.random() * 30 * 24 * 60 * 60 * 1000).toLocaleDateString("en-US", {
            day: "numeric",
            month: "short",
            year: "numeric",
          }),
    ...
    <div className="min-h-screen pb-20 lg:pb-0">
      ...
      <div className="lg:flex lg:gap-6 lg:px-6">
        <div className="flex-1 px-4 lg:px-0 max-w-4xl mx-auto">
          ...
          {/* Job Header Card */}
          <div className={`${theme.cardBg} rounded-xl ${theme.shadow} p-4 lg:p-6 mb-4`}>
            <div className="flex items-start gap-4 mb-4">
              {/* Company Logo */}
              <div className={`w-16 h-16 lg:w-20 lg:h-20 ${theme.primary} rounded-xl flex items-center justify-center flex-shrink-0`}>
              ...
              <div className="flex-1 min-w-0">
                <h1 className={`text-xl lg:text-2xl font-bold ${theme.textPrimary} mb-2`}>
                  {job.title}
                </h1>
                <p className={`text-base lg:text-lg ${theme.textSecondary} mb-2`}>
                  {job.company}
                </p>
                <div className="flex items-center gap-1 text-sm">
                  <svg className={`w-4 h-4 ${theme.textMuted}`} fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex gap-3 lg:gap-4 mb-4">
              <div className={`flex-1 ${theme.bg} rounded-lg p-3 text-center`}>
                ...
                <p className={`text-lg font-bold ${theme.textPrimary}`}>{job.views || 1}</p>
              </div>
              <div className={`flex-1 ${theme.bg} rounded-lg p-3 text-center`}>
                <p className={`text-xs ${theme.textMuted} mb-1`}>Questions</p>
                <p className={`text-lg font-bold ${theme.textPrimary}`}>{job.questions || 1}</p>
              </div>
            </div>

            {/* Tags */}
            <div className="flex flex-wrap gap-2 mb-4">
              <span className={`px-4 py-2 ${theme.primary} ${theme.secondaryText} rounded-full text-sm font-medium`}>
                {job.jobType}
              </span>
              <span className={`px-4 py-2 ${theme.primary} ${theme.secondaryText} rounded-full text-sm font-medium`}>
                {job.workMode}
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm font-semibold ${theme.textPrimary}`}>{job.postedDate}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm font-semibold ${theme.textPrimary}`}>{job.openings || 5} position</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm font-semibold text-red-500`}>{job.deadline}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`${theme.cardBg} rounded-xl ${theme.shadow} p-4 lg:p-6 mb-4`}>
            ...
            <div className={`${theme.textSecondary} text-sm leading-relaxed whitespace-pre-line`}>
              {job.description}
            </div>
          </div>
          ...
          <div className={`${theme.cardBg} rounded-xl ${theme.shadow} p-4 lg:p-6 mb-4`}>
            ...
            <ul className={`space-y-2 ${theme.textSecondary} text-sm`}>
              <li className="flex items-start gap-2">
                ...
                <span>Assist in developing web applications using the MERN stack</span>
              </li>
